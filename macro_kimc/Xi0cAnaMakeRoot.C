		...
		)
{
	...
	TH1F *hPtRS_TePID = MakeTH1("hPtRS_TePID", nBinning, binning);
	TH1F *hPtWS_TePID = MakeTH1("hPtWS_TePID", nBinning, binning);
	TH1F *hPtRS_SePID = MakeTH1("hPtRS_SePID", nBinning, binning);
	TH1F *hPtWS_SePID = MakeTH1("hPtWS_SePID", nBinning, binning);
	TH1F *hPtRS_LePID = MakeTH1("hPtRS_LePID", nBinning, binning);
	TH1F *hPtWS_LePID = MakeTH1("hPtWS_LePID", nBinning, binning);
	TH1F *hPtRS_VTePID = MakeTH1("hPtRS_VTePID", nBinning, binning);
	TH1F *hPtWS_VTePID = MakeTH1("hPtWS_VTePID", nBinning, binning);
	TH1F *hPtRS_VLePID = MakeTH1("hPtRS_VLePID", nBinning, binning);
	TH1F *hPtWS_VLePID = MakeTH1("hPtWS_VLePID", nBinning, binning);

	TH1F *hPtRS_TXiPID = MakeTH1("hPtRS_TXiPID", nBinning, binning);
	TH1F *hPtWS_TXiPID = MakeTH1("hPtWS_TXiPID", nBinning, binning);
	TH1F *hPtRS_SXiPID = MakeTH1("hPtRS_SXiPID", nBinning, binning);
	TH1F *hPtWS_SXiPID = MakeTH1("hPtWS_SXiPID", nBinning, binning);
	TH1F *hPtRS_LXiPID = MakeTH1("hPtRS_LXiPID", nBinning, binning);
	TH1F *hPtWS_LXiPID = MakeTH1("hPtWS_LXiPID", nBinning, binning);
	TH1F *hPtRS_VTXiPID = MakeTH1("hPtRS_VTXiPID", nBinning, binning);
	TH1F *hPtWS_VTXiPID = MakeTH1("hPtWS_VTXiPID", nBinning, binning);
	TH1F *hPtRS_VLXiPID = MakeTH1("hPtRS_VLXiPID", nBinning, binning);
	TH1F *hPtWS_VLXiPID = MakeTH1("hPtWS_VLXiPID", nBinning, binning);

	TH1F *hPtRS_TXiPIDRec = MakeTH1("hPtRS_TXiPIDRec", nBinning, binning);
	TH1F *hPtWS_TXiPIDRec = MakeTH1("hPtWS_TXiPIDRec", nBinning, binning);
	TH1F *hPtRS_SXiPIDRec = MakeTH1("hPtRS_SXiPIDRec", nBinning, binning);
	TH1F *hPtWS_SXiPIDRec = MakeTH1("hPtWS_SXiPIDRec", nBinning, binning);
	TH1F *hPtRS_LXiPIDRec = MakeTH1("hPtRS_LXiPIDRec", nBinning, binning);
	TH1F *hPtWS_LXiPIDRec = MakeTH1("hPtWS_LXiPIDRec", nBinning, binning);
	TH1F *hPtRS_VTXiPIDRec = MakeTH1("hPtRS_VTXiPIDRec", nBinning, binning);
	TH1F *hPtWS_VTXiPIDRec = MakeTH1("hPtWS_VTXiPIDRec", nBinning, binning);
	TH1F *hPtRS_VLXiPIDRec = MakeTH1("hPtRS_VLXiPIDRec", nBinning, binning);
	TH1F *hPtWS_VLXiPIDRec = MakeTH1("hPtWS_VLXiPIDRec", nBinning, binning);

	TH1F *hPtRS_TXiPIDLRec = MakeTH1("hPtRS_TXiPIDLRec", nBinning, binning);
	TH1F *hPtWS_TXiPIDLRec = MakeTH1("hPtWS_TXiPIDLRec", nBinning, binning);
	TH1F *hPtRS_SXiPIDSRec = MakeTH1("hPtRS_SXiPIDSRec", nBinning, binning);
	TH1F *hPtWS_SXiPIDSRec = MakeTH1("hPtWS_SXiPIDSRec", nBinning, binning);
	TH1F *hPtRS_LXiPIDTRec = MakeTH1("hPtRS_LXiPIDTRec", nBinning, binning);
	TH1F *hPtWS_LXiPIDTRec = MakeTH1("hPtWS_LXiPIDTRec", nBinning, binning);
	TH1F *hPtRS_VTXiPIDVLRec = MakeTH1("hPtRS_VTXiPIDVLRec", nBinning, binning);
	TH1F *hPtWS_VTXiPIDVLRec = MakeTH1("hPtWS_VTXiPIDVLRec", nBinning, binning);
	TH1F *hPtRS_VLXiPIDVTRec = MakeTH1("hPtRS_VLXiPIDVTRec", nBinning, binning);
	TH1F *hPtWS_VLXiPIDVTRec = MakeTH1("hPtWS_VLXiPIDVTRec", nBinning, binning);

	TH1F *hPtRS_SXiPID_V0 = MakeTH1("hPtRS_SXiPID_V0", nBinning, binning);
	TH1F *hPtWS_SXiPID_V0 = MakeTH1("hPtWS_SXiPID_V0", nBinning, binning);
	TH1F *hPtRS_SXiPID_Xi = MakeTH1("hPtRS_SXiPID_Xi", nBinning, binning);
	TH1F *hPtWS_SXiPID_Xi = MakeTH1("hPtWS_SXiPID_Xi", nBinning, binning);
	TH1F *hPtRS_SXiPID_DCAb = MakeTH1("hPtRS_SXiPID_DCAb", nBinning, binning);
	TH1F *hPtWS_SXiPID_DCAb = MakeTH1("hPtWS_SXiPID_DCAb", nBinning, binning);

	TH1F *hPtRS_LeRec = MakeTH1("hPtRS_LeRec", nBinning, binning);
	TH1F *hPtWS_LeRec = MakeTH1("hPtWS_LeRec", nBinning, binning);
	TH1F *hPtRS_SeRec = MakeTH1("hPtRS_SeRec", nBinning, binning);
	TH1F *hPtWS_SeRec = MakeTH1("hPtWS_SeRec", nBinning, binning);
	TH1F *hPtRS_TeRec = MakeTH1("hPtRS_TeRec", nBinning, binning);
	TH1F *hPtWS_TeRec = MakeTH1("hPtWS_TeRec", nBinning, binning);
	TH1F *hPtRS_VTeRec = MakeTH1("hPtRS_VTeRec", nBinning, binning);
	TH1F *hPtWS_VTeRec = MakeTH1("hPtWS_VTeRec", nBinning, binning);
	TH1F *hPtRS_VLeRec = MakeTH1("hPtRS_VLeRec", nBinning, binning);
	TH1F *hPtWS_VLeRec = MakeTH1("hPtWS_VLeRec", nBinning, binning);

	TH1F *hPtRS_LXiRec = MakeTH1("hPtRS_LXiRec", nBinning, binning);
	TH1F *hPtWS_LXiRec = MakeTH1("hPtWS_LXiRec", nBinning, binning);
	TH1F *hPtRS_SXiRec = MakeTH1("hPtRS_SXiRec", nBinning, binning);
	TH1F *hPtWS_SXiRec = MakeTH1("hPtWS_SXiRec", nBinning, binning);
	TH1F *hPtRS_TXiRec = MakeTH1("hPtRS_TXiRec", nBinning, binning);
	TH1F *hPtWS_TXiRec = MakeTH1("hPtWS_TXiRec", nBinning, binning);
	TH1F *hPtRS_VTXiRec = MakeTH1("hPtRS_VTXiRec", nBinning, binning);
	TH1F *hPtWS_VTXiRec = MakeTH1("hPtWS_VTXiRec", nBinning, binning);
	TH1F *hPtRS_VLXiRec = MakeTH1("hPtRS_VLXiRec", nBinning, binning);
	TH1F *hPtWS_VLXiRec = MakeTH1("hPtWS_VLXiRec", nBinning, binning);

	TH1F *hPtRS_LeIM = MakeTH1("hPtRS_LeIM", nBinning, binning);
	TH1F *hPtWS_LeIM = MakeTH1("hPtWS_LeIM", nBinning, binning);
	TH1F *hPtRS_SeIM = MakeTH1("hPtRS_SeIM", nBinning, binning);
	TH1F *hPtWS_SeIM = MakeTH1("hPtWS_SeIM", nBinning, binning);
	TH1F *hPtRS_TeIM = MakeTH1("hPtRS_TeIM", nBinning, binning);
	TH1F *hPtWS_TeIM = MakeTH1("hPtWS_TeIM", nBinning, binning);

	TH1F *hPtRS_LOA = MakeTH1("hPtRS_LOA", nBinning, binning);
	TH1F *hPtWS_LOA = MakeTH1("hPtWS_LOA", nBinning, binning);
	TH1F *hPtRS_TOA = MakeTH1("hPtRS_TOA", nBinning, binning);
	TH1F *hPtWS_TOA = MakeTH1("hPtWS_TOA", nBinning, binning);
	TH1F *hPtRS_SOA = MakeTH1("hPtRS_SOA", nBinning, binning);
	TH1F *hPtWS_SOA = MakeTH1("hPtWS_SOA", nBinning, binning);
	...
	TH1F *hpre_eRec_loose_de = MakeTH1("hpre_eRec_loose_de", nBinning, binning);
	TH1F *hpre_eRec_loose_nu = MakeTH1("hpre_eRec_loose_nu", nBinning, binning);
	TH1F *hpre_eRec_stand_de = MakeTH1("hpre_eRec_stand_de", nBinning, binning);
	TH1F *hpre_eRec_stand_nu = MakeTH1("hpre_eRec_stand_nu", nBinning, binning);
	TH1F *hpre_eRec_tight_de = MakeTH1("hpre_eRec_tight_de", nBinning, binning);
	TH1F *hpre_eRec_tight_nu = MakeTH1("hpre_eRec_tight_nu", nBinning, binning);
	TH1F *hpre_eRec_vloose_de = MakeTH1("hpre_eRec_vloose_de", nBinning, binning);
	TH1F *hpre_eRec_vloose_nu = MakeTH1("hpre_eRec_vloose_nu", nBinning, binning);
	TH1F *hpre_eRec_vtight_de = MakeTH1("hpre_eRec_vtight_de", nBinning, binning);
	TH1F *hpre_eRec_vtight_nu = MakeTH1("hpre_eRec_vtight_nu", nBinning, binning);

	TH1F *hpre_XiRec_loose_de = MakeTH1("hpre_XiRec_loose_de", nBinning, binning);
	TH1F *hpre_XiRec_loose_nu = MakeTH1("hpre_XiRec_loose_nu", nBinning, binning);
	TH1F *hpre_XiRec_stand_de = MakeTH1("hpre_XiRec_stand_de", nBinning, binning);
	TH1F *hpre_XiRec_stand_nu = MakeTH1("hpre_XiRec_stand_nu", nBinning, binning);
	TH1F *hpre_XiRec_tight_de = MakeTH1("hpre_XiRec_tight_de", nBinning, binning);
	TH1F *hpre_XiRec_tight_nu = MakeTH1("hpre_XiRec_tight_nu", nBinning, binning);
	TH1F *hpre_XiRec_vloose_de = MakeTH1("hpre_XiRec_vloose_de", nBinning, binning);
	TH1F *hpre_XiRec_vloose_nu = MakeTH1("hpre_XiRec_vloose_nu", nBinning, binning);
	TH1F *hpre_XiRec_vtight_de = MakeTH1("hpre_XiRec_vtight_de", nBinning, binning);
	TH1F *hpre_XiRec_vtight_nu = MakeTH1("hpre_XiRec_vtight_nu", nBinning, binning);

	TH1F *hpre_ePID_loose_de = MakeTH1("hpre_ePID_loose_de", nBinning, binning);
	TH1F *hpre_ePID_loose_nu = MakeTH1("hpre_ePID_loose_nu", nBinning, binning);
	TH1F *hpre_ePID_stand_de = MakeTH1("hpre_ePID_stand_de", nBinning, binning);
	TH1F *hpre_ePID_stand_nu = MakeTH1("hpre_ePID_stand_nu", nBinning, binning);
	TH1F *hpre_ePID_tight_de = MakeTH1("hpre_ePID_tight_de", nBinning, binning);
	TH1F *hpre_ePID_tight_nu = MakeTH1("hpre_ePID_tight_nu", nBinning, binning);
	TH1F *hpre_ePID_vloose_de = MakeTH1("hpre_ePID_vloose_de", nBinning, binning);
	TH1F *hpre_ePID_vloose_nu = MakeTH1("hpre_ePID_vloose_nu", nBinning, binning);
	TH1F *hpre_ePID_vtight_de = MakeTH1("hpre_ePID_vtight_de", nBinning, binning);
	TH1F *hpre_ePID_vtight_nu = MakeTH1("hpre_ePID_vtight_nu", nBinning, binning);

	TH1F *hpre_XiPID_loose_de = MakeTH1("hpre_XiPID_loose_de", nBinning, binning);
	TH1F *hpre_XiPID_loose_nu = MakeTH1("hpre_XiPID_loose_nu", nBinning, binning);
	TH1F *hpre_XiPID_stand_de = MakeTH1("hpre_XiPID_stand_de", nBinning, binning);
	TH1F *hpre_XiPID_stand_nu = MakeTH1("hpre_XiPID_stand_nu", nBinning, binning);
	TH1F *hpre_XiPID_tight_de = MakeTH1("hpre_XiPID_tight_de", nBinning, binning);
	TH1F *hpre_XiPID_tight_nu = MakeTH1("hpre_XiPID_tight_nu", nBinning, binning);
	TH1F *hpre_XiPID_vloose_de = MakeTH1("hpre_XiPID_vloose_de", nBinning, binning);
	TH1F *hpre_XiPID_vloose_nu = MakeTH1("hpre_XiPID_vloose_nu", nBinning, binning);
	TH1F *hpre_XiPID_vtight_de = MakeTH1("hpre_XiPID_vtight_de", nBinning, binning);
	TH1F *hpre_XiPID_vtight_nu = MakeTH1("hpre_XiPID_vtight_nu", nBinning, binning);

	TH1F *hpre_XiPIDRec_loose_de = MakeTH1("hpre_XiPIDRec_loose_de", nBinning, binning);
	TH1F *hpre_XiPIDRec_loose_nu = MakeTH1("hpre_XiPIDRec_loose_nu", nBinning, binning);
	TH1F *hpre_XiPIDRec_stand_de = MakeTH1("hpre_XiPIDRec_stand_de", nBinning, binning);
	TH1F *hpre_XiPIDRec_stand_nu = MakeTH1("hpre_XiPIDRec_stand_nu", nBinning, binning);
	TH1F *hpre_XiPIDRec_tight_de = MakeTH1("hpre_XiPIDRec_tight_de", nBinning, binning);
	TH1F *hpre_XiPIDRec_tight_nu = MakeTH1("hpre_XiPIDRec_tight_nu", nBinning, binning);
	TH1F *hpre_XiPIDRec_vloose_de = MakeTH1("hpre_XiPIDRec_vloose_de", nBinning, binning);
	TH1F *hpre_XiPIDRec_vloose_nu = MakeTH1("hpre_XiPIDRec_vloose_nu", nBinning, binning);
	TH1F *hpre_XiPIDRec_vtight_de = MakeTH1("hpre_XiPIDRec_vtight_de", nBinning, binning);
	TH1F *hpre_XiPIDRec_vtight_nu = MakeTH1("hpre_XiPIDRec_vtight_nu", nBinning, binning);

	TH1F *hpre_XiPIDinvRec_loose_de = MakeTH1("hpre_XiPIDinvRec_loose_de", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_loose_nu = MakeTH1("hpre_XiPIDinvRec_loose_nu", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_stand_de = MakeTH1("hpre_XiPIDinvRec_stand_de", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_stand_nu = MakeTH1("hpre_XiPIDinvRec_stand_nu", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_tight_de = MakeTH1("hpre_XiPIDinvRec_tight_de", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_tight_nu = MakeTH1("hpre_XiPIDinvRec_tight_nu", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_vloose_de = MakeTH1("hpre_XiPIDinvRec_vloose_de", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_vloose_nu = MakeTH1("hpre_XiPIDinvRec_vloose_nu", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_vtight_de = MakeTH1("hpre_XiPIDinvRec_vtight_de", nBinning, binning);
	TH1F *hpre_XiPIDinvRec_vtight_nu = MakeTH1("hpre_XiPIDinvRec_vtight_nu", nBinning, binning);

	TH1F *hpre_OA_loose_de = MakeTH1("hpre_OA_loose_de", nBinning, binning);
	TH1F *hpre_OA_loose_nu = MakeTH1("hpre_OA_loose_nu", nBinning, binning);
	TH1F *hpre_OA_stand_de = MakeTH1("hpre_OA_stand_de", nBinning, binning);
	TH1F *hpre_OA_stand_nu = MakeTH1("hpre_OA_stand_nu", nBinning, binning);
	TH1F *hpre_OA_tight_de = MakeTH1("hpre_OA_tight_de", nBinning, binning);
	TH1F *hpre_OA_tight_nu = MakeTH1("hpre_OA_tight_nu", nBinning, binning);

	TH1F *hpre_IM_loose_de = MakeTH1("hpre_IM_loose_de", nBinning, binning);
	TH1F *hpre_IM_loose_nu = MakeTH1("hpre_IM_loose_nu", nBinning, binning);
	TH1F *hpre_IM_stand_de = MakeTH1("hpre_IM_stand_de", nBinning, binning);
	TH1F *hpre_IM_stand_nu = MakeTH1("hpre_IM_stand_nu", nBinning, binning);
	TH1F *hpre_IM_tight_de = MakeTH1("hpre_IM_tight_de", nBinning, binning);
	TH1F *hpre_IM_tight_nu = MakeTH1("hpre_IM_tight_nu", nBinning, binning);

	TH1F *hpre_Bayes_stand2_de = MakeTH1("hpre_Bayes_stand2_de", nBinning, binning);
	TH1F *hpre_Bayes_stand2_nu = MakeTH1("hpre_Bayes_stand2_nu", nBinning, binning);
	TH1F *hpre_Bayes_stand3_de = MakeTH1("hpre_Bayes_stand3_de", nBinning, binning);
	TH1F *hpre_Bayes_stand3_nu = MakeTH1("hpre_Bayes_stand3_nu", nBinning, binning);
	TH1F *hpre_Bayes_stand4_de = MakeTH1("hpre_Bayes_stand4_de", nBinning, binning);
	TH1F *hpre_Bayes_stand4_nu = MakeTH1("hpre_Bayes_stand4_nu", nBinning, binning);
	TH1F *hpre_Bayes_stand5_de = MakeTH1("hpre_Bayes_stand5_de", nBinning, binning);
	TH1F *hpre_Bayes_stand5_nu = MakeTH1("hpre_Bayes_stand5_nu", nBinning, binning);
	TH1F *hpre_Bayes_stand6_de = MakeTH1("hpre_Bayes_stand6_de", nBinning, binning);
	TH1F *hpre_Bayes_stand6_nu = MakeTH1("hpre_Bayes_stand6_nu", nBinning, binning);
	TH1F *hpre_Bayes_stand7_de = MakeTH1("hpre_Bayes_stand7_de", nBinning, binning);
	TH1F *hpre_Bayes_stand7_nu = MakeTH1("hpre_Bayes_stand7_nu", nBinning, binning);

	TH1F *hpre_Svd_stand3_de = MakeTH1("hpre_Svd_stand3_de", nBinning, binning);
	TH1F *hpre_Svd_stand3_nu = MakeTH1("hpre_Svd_stand3_nu", nBinning, binning);
	TH1F *hpre_Svd_stand4_de = MakeTH1("hpre_Svd_stand4_de", nBinning, binning);
	...
	TH1F* hMCRecoLevXic0_eRec_loose = MakeTH1("hMCRecoLevXic0_eRec_loose", nBinning, binning); //Xic0 in gen level
	TH1F* hMCRecoLevPair_eRec_loose = MakeTH1("hMCRecoLevPair_eRec_loose", nBinning, binning); //eXi pair decay from Xic0 in generation level
	TH2F* hRPM_eRec_stand_un        = MakeTH2("hRPM_eRec_stand_un", nBinning, binning);
	TH2F* hRPM_eRec_stand           = MakeTH2("hRPM_eRec_stand", nBinning, binning);
	TH1F* hMCRecoLevXic0_eRec_stand = MakeTH1("hMCRecoLevXic0_eRec_stand", nBinning, binning);
	TH1F* hMCRecoLevPair_eRec_stand = MakeTH1("hMCRecoLevPair_eRec_stand", nBinning, binning);
	TH2F* hRPM_eRec_tight_un        = MakeTH2("hRPM_eRec_tight_un", nBinning, binning);
	TH2F* hRPM_eRec_tight           = MakeTH2("hRPM_eRec_tight", nBinning, binning);
	TH1F* hMCRecoLevXic0_eRec_tight = MakeTH1("hMCRecoLevXic0_eRec_tight", nBinning, binning);
	TH1F* hMCRecoLevPair_eRec_tight = MakeTH1("hMCRecoLevPair_eRec_tight", nBinning, binning);
	TH2F* hRPM_eRec_vloose_un        = MakeTH2("hRPM_eRec_vloose_un", nBinning, binning);
	TH2F* hRPM_eRec_vloose           = MakeTH2("hRPM_eRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevXic0_eRec_vloose = MakeTH1("hMCRecoLevXic0_eRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevPair_eRec_vloose = MakeTH1("hMCRecoLevPair_eRec_vloose", nBinning, binning);
	TH2F* hRPM_eRec_vtight_un        = MakeTH2("hRPM_eRec_vtight_un", nBinning, binning);
	TH2F* hRPM_eRec_vtight           = MakeTH2("hRPM_eRec_vtight", nBinning, binning);
	TH1F* hMCRecoLevXic0_eRec_vtight = MakeTH1("hMCRecoLevXic0_eRec_vtight", nBinning, binning);
	TH1F* hMCRecoLevPair_eRec_vtight = MakeTH1("hMCRecoLevPair_eRec_vtight", nBinning, binning);

	TH2F* hRPM_ePID_loose_un        = MakeTH2("hRPM_ePID_loose_un", nBinning, binning);
	TH2F* hRPM_ePID_loose           = MakeTH2("hRPM_ePID_loose", nBinning, binning);
	TH1F* hMCRecoLevXic0_ePID_loose = MakeTH1("hMCRecoLevXic0_ePID_loose", nBinning, binning);
	TH1F* hMCRecoLevPair_ePID_loose = MakeTH1("hMCRecoLevPair_ePID_loose", nBinning, binning);
	TH2F* hRPM_ePID_stand_un        = MakeTH2("hRPM_ePID_stand_un", nBinning, binning);
	TH2F* hRPM_ePID_stand           = MakeTH2("hRPM_ePID_stand", nBinning, binning);
	TH1F* hMCRecoLevXic0_ePID_stand = MakeTH1("hMCRecoLevXic0_ePID_stand", nBinning, binning);
	TH1F* hMCRecoLevPair_ePID_stand = MakeTH1("hMCRecoLevPair_ePID_stand", nBinning, binning);
	TH2F* hRPM_ePID_tight_un        = MakeTH2("hRPM_ePID_tight_un", nBinning, binning);
	TH2F* hRPM_ePID_tight           = MakeTH2("hRPM_ePID_tight", nBinning, binning);
	TH1F* hMCRecoLevXic0_ePID_tight = MakeTH1("hMCRecoLevXic0_ePID_tight", nBinning, binning);
	TH1F* hMCRecoLevPair_ePID_tight = MakeTH1("hMCRecoLevPair_ePID_tight", nBinning, binning);
	TH2F* hRPM_ePID_vloose_un        = MakeTH2("hRPM_ePID_vloose_un", nBinning, binning);
	TH2F* hRPM_ePID_vloose           = MakeTH2("hRPM_ePID_vloose", nBinning, binning);
	TH1F* hMCRecoLevXic0_ePID_vloose = MakeTH1("hMCRecoLevXic0_ePID_vloose", nBinning, binning);
	TH1F* hMCRecoLevPair_ePID_vloose = MakeTH1("hMCRecoLevPair_ePID_vloose", nBinning, binning);
	TH2F* hRPM_ePID_vtight_un        = MakeTH2("hRPM_ePID_vtight_un", nBinning, binning);
	TH2F* hRPM_ePID_vtight           = MakeTH2("hRPM_ePID_vtight", nBinning, binning);
	TH1F* hMCRecoLevXic0_ePID_vtight = MakeTH1("hMCRecoLevXic0_ePID_vtight", nBinning, binning);
	TH1F* hMCRecoLevPair_ePID_vtight = MakeTH1("hMCRecoLevPair_ePID_vtight", nBinning, binning);

	TH2F* hRPM_XiRec_loose_un        = MakeTH2("hRPM_XiRec_loose_un", nBinning, binning);
	TH2F* hRPM_XiRec_loose           = MakeTH2("hRPM_XiRec_loose", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiRec_loose = MakeTH1("hMCRecoLevXic0_XiRec_loose", nBinning, binning);
	TH1F* hMCRecoLevPair_XiRec_loose = MakeTH1("hMCRecoLevPair_XiRec_loose", nBinning, binning);
	TH2F* hRPM_XiRec_stand_un        = MakeTH2("hRPM_XiRec_stand_un", nBinning, binning);
	TH2F* hRPM_XiRec_stand           = MakeTH2("hRPM_XiRec_stand", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiRec_stand = MakeTH1("hMCRecoLevXic0_XiRec_stand", nBinning, binning);
	TH1F* hMCRecoLevPair_XiRec_stand = MakeTH1("hMCRecoLevPair_XiRec_stand", nBinning, binning);
	TH2F* hRPM_XiRec_tight_un        = MakeTH2("hRPM_XiRec_tight_un", nBinning, binning);
	TH2F* hRPM_XiRec_tight           = MakeTH2("hRPM_XiRec_tight", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiRec_tight = MakeTH1("hMCRecoLevXic0_XiRec_tight", nBinning, binning);
	TH1F* hMCRecoLevPair_XiRec_tight = MakeTH1("hMCRecoLevPair_XiRec_tight", nBinning, binning);
	TH2F* hRPM_XiRec_vloose_un        = MakeTH2("hRPM_XiRec_vloose_un", nBinning, binning);
	TH2F* hRPM_XiRec_vloose           = MakeTH2("hRPM_XiRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiRec_vloose = MakeTH1("hMCRecoLevXic0_XiRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevPair_XiRec_vloose = MakeTH1("hMCRecoLevPair_XiRec_vloose", nBinning, binning);
	TH2F* hRPM_XiRec_vtight_un        = MakeTH2("hRPM_XiRec_vtight_un", nBinning, binning);
	TH2F* hRPM_XiRec_vtight           = MakeTH2("hRPM_XiRec_vtight", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiRec_vtight = MakeTH1("hMCRecoLevXic0_XiRec_vtight", nBinning, binning);
	TH1F* hMCRecoLevPair_XiRec_vtight = MakeTH1("hMCRecoLevPair_XiRec_vtight", nBinning, binning);

	TH2F* hRPM_XiPID_loose_un        = MakeTH2("hRPM_XiPID_loose_un", nBinning, binning);
	TH2F* hRPM_XiPID_loose           = MakeTH2("hRPM_XiPID_loose", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiPID_loose = MakeTH1("hMCRecoLevXic0_XiPID_loose", nBinning, binning);
	TH1F* hMCRecoLevPair_XiPID_loose = MakeTH1("hMCRecoLevPair_XiPID_loose", nBinning, binning);
	TH2F* hRPM_XiPID_stand_un        = MakeTH2("hRPM_XiPID_stand_un", nBinning, binning);
	TH2F* hRPM_XiPID_stand           = MakeTH2("hRPM_XiPID_stand", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiPID_stand = MakeTH1("hMCRecoLevXic0_XiPID_stand", nBinning, binning);
	TH1F* hMCRecoLevPair_XiPID_stand = MakeTH1("hMCRecoLevPair_XiPID_stand", nBinning, binning);
	TH2F* hRPM_XiPID_tight_un        = MakeTH2("hRPM_XiPID_tight_un", nBinning, binning);
	TH2F* hRPM_XiPID_tight           = MakeTH2("hRPM_XiPID_tight", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiPID_tight = MakeTH1("hMCRecoLevXic0_XiPID_tight", nBinning, binning);
	TH1F* hMCRecoLevPair_XiPID_tight = MakeTH1("hMCRecoLevPair_XiPID_tight", nBinning, binning);
	TH2F* hRPM_XiPID_vloose_un        = MakeTH2("hRPM_XiPID_vloose_un", nBinning, binning);
	TH2F* hRPM_XiPID_vloose           = MakeTH2("hRPM_XiPID_vloose", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiPID_vloose = MakeTH1("hMCRecoLevXic0_XiPID_vloose", nBinning, binning);
	TH1F* hMCRecoLevPair_XiPID_vloose = MakeTH1("hMCRecoLevPair_XiPID_vloose", nBinning, binning);
	TH2F* hRPM_XiPID_vtight_un        = MakeTH2("hRPM_XiPID_vtight_un", nBinning, binning);
	TH2F* hRPM_XiPID_vtight           = MakeTH2("hRPM_XiPID_vtight", nBinning, binning);
	TH1F* hMCRecoLevXic0_XiPID_vtight = MakeTH1("hMCRecoLevXic0_XiPID_vtight", nBinning, binning);
	TH1F* hMCRecoLevPair_XiPID_vtight = MakeTH1("hMCRecoLevPair_XiPID_vtight", nBinning, binning);

	TH2F* hRPM_op_loose_un        = MakeTH2("hRPM_OA_loose_un", nBinning, binning);
	TH2F* hRPM_op_loose           = MakeTH2("hRPM_OA_loose", nBinning, binning);
	TH1F* hMCRecoLevXic0_op_loose = MakeTH1("hMCRecoLevXic0_OA_loose", nBinning, binning);
	TH1F* hMCRecoLevPair_op_loose = MakeTH1("hMCRecoLevPair_OA_loose", nBinning, binning);
	TH2F* hRPM_op_stand_un        = MakeTH2("hRPM_OA_stand_un", nBinning, binning);
	TH2F* hRPM_op_stand           = MakeTH2("hRPM_OA_stand", nBinning, binning);
	TH1F* hMCRecoLevXic0_op_stand = MakeTH1("hMCRecoLevXic0_OA_stand", nBinning, binning);
	TH1F* hMCRecoLevPair_op_stand = MakeTH1("hMCRecoLevPair_OA_stand", nBinning, binning);
	TH2F* hRPM_op_tight_un        = MakeTH2("hRPM_OA_tight_un", nBinning, binning);
	TH2F* hRPM_op_tight           = MakeTH2("hRPM_OA_tight", nBinning, binning);
	TH1F* hMCRecoLevXic0_op_tight = MakeTH1("hMCRecoLevXic0_OA_tight", nBinning, binning);
	TH1F* hMCRecoLevPair_op_tight = MakeTH1("hMCRecoLevPair_OA_tight", nBinning, binning);

	TH2F* hRPM_im_loose_un        = MakeTH2("hRPM_IM_loose_un", nBinning, binning);
	TH2F* hRPM_im_loose           = MakeTH2("hRPM_IM_loose", nBinning, binning);
	TH1F* hMCRecoLevXic0_im_loose = MakeTH1("hMCRecoLevXic0_IM_loose", nBinning, binning);
	TH1F* hMCRecoLevPair_im_loose = MakeTH1("hMCRecoLevPair_IM_loose", nBinning, binning);
	TH2F* hRPM_im_stand_un        = MakeTH2("hRPM_IM_stand_un", nBinning, binning);
	TH2F* hRPM_im_stand           = MakeTH2("hRPM_IM_stand", nBinning, binning);
	TH1F* hMCRecoLevXic0_im_stand = MakeTH1("hMCRecoLevXic0_IM_stand", nBinning, binning);
	TH1F* hMCRecoLevPair_im_stand = MakeTH1("hMCRecoLevPair_IM_stand", nBinning, binning);
	TH2F* hRPM_im_tight_un        = MakeTH2("hRPM_IM_tight_un", nBinning, binning);
	TH2F* hRPM_im_tight           = MakeTH2("hRPM_IM_tight", nBinning, binning);
	TH1F* hMCRecoLevXic0_im_tight = MakeTH1("hMCRecoLevXic0_IM_tight", nBinning, binning);
	TH1F* hMCRecoLevPair_im_tight = MakeTH1("hMCRecoLevPair_IM_tight", nBinning, binning);

	TH2F* hRPM_eRec_loose_Xib          = MakeTH2("hRPM_eRec_loose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_eRec_loose     = MakeTH1("hMCRecoLevXib_eRec_loose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_eRec_loose = MakeTH1("hMCRecoLevPairXib_eRec_loose", nBinning, binning);
	TH2F* hRPM_eRec_stand_Xib          = MakeTH2("hRPM_eRec_stand_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_eRec_stand     = MakeTH1("hMCRecoLevXib_eRec_stand", nBinning, binning);
	TH1F* hMCRecoLevPairXib_eRec_stand = MakeTH1("hMCRecoLevPairXib_eRec_stand", nBinning, binning);
	TH2F* hRPM_eRec_tight_Xib          = MakeTH2("hRPM_eRec_tight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_eRec_tight     = MakeTH1("hMCRecoLevXib_eRec_tight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_eRec_tight = MakeTH1("hMCRecoLevPairXib_eRec_tight", nBinning, binning);
	TH2F* hRPM_eRec_vloose_Xib          = MakeTH2("hRPM_eRec_vloose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_eRec_vloose     = MakeTH1("hMCRecoLevXib_eRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_eRec_vloose = MakeTH1("hMCRecoLevPairXib_eRec_vloose", nBinning, binning);
	TH2F* hRPM_eRec_vtight_Xib          = MakeTH2("hRPM_eRec_vtight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_eRec_vtight     = MakeTH1("hMCRecoLevXib_eRec_vtight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_eRec_vtight = MakeTH1("hMCRecoLevPairXib_eRec_vtight", nBinning, binning);

	TH2F* hRPM_ePID_loose_Xib          = MakeTH2("hRPM_ePID_loose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_ePID_loose     = MakeTH1("hMCRecoLevXib_ePID_loose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_ePID_loose = MakeTH1("hMCRecoLevPairXib_ePID_loose", nBinning, binning);
	TH2F* hRPM_ePID_stand_Xib          = MakeTH2("hRPM_ePID_stand_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_ePID_stand     = MakeTH1("hMCRecoLevXib_ePID_stand", nBinning, binning);
	TH1F* hMCRecoLevPairXib_ePID_stand = MakeTH1("hMCRecoLevPairXib_ePID_stand", nBinning, binning);
	TH2F* hRPM_ePID_tight_Xib          = MakeTH2("hRPM_ePID_tight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_ePID_tight     = MakeTH1("hMCRecoLevXib_ePID_tight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_ePID_tight = MakeTH1("hMCRecoLevPairXib_ePID_tight", nBinning, binning);
	TH2F* hRPM_ePID_vloose_Xib          = MakeTH2("hRPM_ePID_vloose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_ePID_vloose     = MakeTH1("hMCRecoLevXib_ePID_vloose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_ePID_vloose = MakeTH1("hMCRecoLevPairXib_ePID_vloose", nBinning, binning);
	TH2F* hRPM_ePID_vtight_Xib          = MakeTH2("hRPM_ePID_vtight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_ePID_vtight     = MakeTH1("hMCRecoLevXib_ePID_vtight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_ePID_vtight = MakeTH1("hMCRecoLevPairXib_ePID_vtight", nBinning, binning);

	TH2F* hRPM_XiPID_loose_Xib          = MakeTH2("hRPM_XiPID_loose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiPID_loose     = MakeTH1("hMCRecoLevXib_XiPID_loose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiPID_loose = MakeTH1("hMCRecoLevPairXib_XiPID_loose", nBinning, binning);
	TH2F* hRPM_XiPID_stand_Xib          = MakeTH2("hRPM_XiPID_stand_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiPID_stand     = MakeTH1("hMCRecoLevXib_XiPID_stand", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiPID_stand = MakeTH1("hMCRecoLevPairXib_XiPID_stand", nBinning, binning);
	TH2F* hRPM_XiPID_tight_Xib          = MakeTH2("hRPM_XiPID_tight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiPID_tight     = MakeTH1("hMCRecoLevXib_XiPID_tight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiPID_tight = MakeTH1("hMCRecoLevPairXib_XiPID_tight", nBinning, binning);
	TH2F* hRPM_XiPID_vloose_Xib          = MakeTH2("hRPM_XiPID_vloose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiPID_vloose     = MakeTH1("hMCRecoLevXib_XiPID_vloose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiPID_vloose = MakeTH1("hMCRecoLevPairXib_XiPID_vloose", nBinning, binning);
	TH2F* hRPM_XiPID_vtight_Xib          = MakeTH2("hRPM_XiPID_vtight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiPID_vtight     = MakeTH1("hMCRecoLevXib_XiPID_vtight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiPID_vtight = MakeTH1("hMCRecoLevPairXib_XiPID_vtight", nBinning, binning);

	TH2F* hRPM_XiRec_loose_Xib          = MakeTH2("hRPM_XiRec_loose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiRec_loose     = MakeTH1("hMCRecoLevXib_XiRec_loose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiRec_loose = MakeTH1("hMCRecoLevPairXib_XiRec_loose", nBinning, binning);
	TH2F* hRPM_XiRec_stand_Xib          = MakeTH2("hRPM_XiRec_stand_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiRec_stand     = MakeTH1("hMCRecoLevXib_XiRec_stand", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiRec_stand = MakeTH1("hMCRecoLevPairXib_XiRec_stand", nBinning, binning);
	TH2F* hRPM_XiRec_tight_Xib          = MakeTH2("hRPM_XiRec_tight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiRec_tight     = MakeTH1("hMCRecoLevXib_XiRec_tight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiRec_tight = MakeTH1("hMCRecoLevPairXib_XiRec_tight", nBinning, binning);
	TH2F* hRPM_XiRec_vloose_Xib          = MakeTH2("hRPM_XiRec_vloose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiRec_vloose     = MakeTH1("hMCRecoLevXib_XiRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiRec_vloose = MakeTH1("hMCRecoLevPairXib_XiRec_vloose", nBinning, binning);
	TH2F* hRPM_XiRec_vtight_Xib          = MakeTH2("hRPM_XiRec_vtight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_XiRec_vtight     = MakeTH1("hMCRecoLevXib_XiRec_vtight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_XiRec_vtight = MakeTH1("hMCRecoLevPairXib_XiRec_vtight", nBinning, binning);

	TH2F* hRPM_im_loose_Xib          = MakeTH2("hRPM_IM_loose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_im_loose     = MakeTH1("hMCRecoLevXib_IM_loose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_im_loose = MakeTH1("hMCRecoLevPairXib_IM_loose", nBinning, binning);
	TH2F* hRPM_im_stand_Xib          = MakeTH2("hRPM_IM_stand_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_im_stand     = MakeTH1("hMCRecoLevXib_IM_stand", nBinning, binning);
	TH1F* hMCRecoLevPairXib_im_stand = MakeTH1("hMCRecoLevPairXib_IM_stand", nBinning, binning);
	TH2F* hRPM_im_tight_Xib          = MakeTH2("hRPM_IM_tight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_im_tight     = MakeTH1("hMCRecoLevXib_IM_tight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_im_tight = MakeTH1("hMCRecoLevPairXib_IM_tight", nBinning, binning);

	TH2F* hRPM_op_loose_Xib          = MakeTH2("hRPM_OA_loose_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_op_loose     = MakeTH1("hMCRecoLevXib_OA_loose", nBinning, binning);
	TH1F* hMCRecoLevPairXib_op_loose = MakeTH1("hMCRecoLevPairXib_OA_loose", nBinning, binning);
	TH2F* hRPM_op_stand_Xib          = MakeTH2("hRPM_OA_stand_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_op_stand     = MakeTH1("hMCRecoLevXib_OA_stand", nBinning, binning);
	TH1F* hMCRecoLevPairXib_op_stand = MakeTH1("hMCRecoLevPairXib_OA_stand", nBinning, binning);
	TH2F* hRPM_op_tight_Xib          = MakeTH2("hRPM_OA_tight_Xib", nBinning, binning);
	TH1F* hMCRecoLevXib_op_tight     = MakeTH1("hMCRecoLevXib_OA_tight", nBinning, binning);
	TH1F* hMCRecoLevPairXib_op_tight = MakeTH1("hMCRecoLevPairXib_OA_tight", nBinning, binning);

	TH1F* hMCRecoLevPromptXic0_eRec_loose = MakeTH1("hMCRecoLevPromptXic0_eRec_loose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_eRec_stand = MakeTH1("hMCRecoLevPromptXic0_eRec_stand", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_eRec_tight = MakeTH1("hMCRecoLevPromptXic0_eRec_tight", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_eRec_vloose = MakeTH1("hMCRecoLevPromptXic0_eRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_eRec_vtight = MakeTH1("hMCRecoLevPromptXic0_eRec_vtight", nBinning, binning);

	TH1F* hMCRecoLevPromptXic0_XiRec_loose = MakeTH1("hMCRecoLevPromptXic0_XiRec_loose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiRec_stand = MakeTH1("hMCRecoLevPromptXic0_XiRec_stand", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiRec_tight = MakeTH1("hMCRecoLevPromptXic0_XiRec_tight", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiRec_vloose = MakeTH1("hMCRecoLevPromptXic0_XiRec_vloose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiRec_vtight = MakeTH1("hMCRecoLevPromptXic0_XiRec_vtight", nBinning, binning);

	TH1F* hMCRecoLevPromptXic0_ePID_loose = MakeTH1("hMCRecoLevPromptXic0_ePID_loose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_ePID_stand = MakeTH1("hMCRecoLevPromptXic0_ePID_stand", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_ePID_tight = MakeTH1("hMCRecoLevPromptXic0_ePID_tight", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_ePID_vloose = MakeTH1("hMCRecoLevPromptXic0_ePID_vloose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_ePID_vtight = MakeTH1("hMCRecoLevPromptXic0_ePID_vtight", nBinning, binning);

	TH1F* hMCRecoLevPromptXic0_XiPID_loose = MakeTH1("hMCRecoLevPromptXic0_XiPID_loose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiPID_stand = MakeTH1("hMCRecoLevPromptXic0_XiPID_stand", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiPID_tight = MakeTH1("hMCRecoLevPromptXic0_XiPID_tight", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiPID_vloose = MakeTH1("hMCRecoLevPromptXic0_XiPID_vloose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_XiPID_vtight = MakeTH1("hMCRecoLevPromptXic0_XiPID_vtight", nBinning, binning);

	TH1F* hMCRecoLevPromptXic0_IM_loose = MakeTH1("hMCRecoLevPromptXic0_IM_loose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_IM_stand = MakeTH1("hMCRecoLevPromptXic0_IM_stand", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_IM_tight = MakeTH1("hMCRecoLevPromptXic0_IM_tight", nBinning, binning);

	TH1F* hMCRecoLevPromptXic0_OA_loose = MakeTH1("hMCRecoLevPromptXic0_OA_loose", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_OA_stand = MakeTH1("hMCRecoLevPromptXic0_OA_stand", nBinning, binning);
	TH1F* hMCRecoLevPromptXic0_OA_tight = MakeTH1("hMCRecoLevPromptXic0_OA_tight", nBinning, binning);
