...
void eXiPairTree(TFile* F, bool IsMC, const char* SDIR, const char* TRIG, double* MultPerc, double* WFitPar)
{
	...
	Double_t binning1[] = {1.,2.,3.,4.,5.,6.,8.,12.,16.,20}; //10
    ...
    TH1F *hPtRS_TePID = MakeTH1("hPtRS_TePID",9,binning1);
	TH1F *hPtWS_TePID = MakeTH1("hPtWS_TePID",9,binning1);
    TH1F *hPtRS_SePID = MakeTH1("hPtRS_SePID",9,binning1);
	TH1F *hPtWS_SePID = MakeTH1("hPtWS_SePID",9,binning1);
    TH1F *hPtRS_LePID = MakeTH1("hPtRS_LePID",9,binning1);
	TH1F *hPtWS_LePID = MakeTH1("hPtWS_LePID",9,binning1);
    TH1F *hPtRS_VTePID = MakeTH1("hPtRS_VTePID",9,binning1);
	TH1F *hPtWS_VTePID = MakeTH1("hPtWS_VTePID",9,binning1);
    TH1F *hPtRS_VLePID = MakeTH1("hPtRS_VLePID",9,binning1);
	TH1F *hPtWS_VLePID = MakeTH1("hPtWS_VLePID",9,binning1);

    TH1F *hPtRS_TXiPID = MakeTH1("hPtRS_TXiPID",9,binning1);
	TH1F *hPtWS_TXiPID = MakeTH1("hPtWS_TXiPID",9,binning1);
    TH1F *hPtRS_SXiPID = MakeTH1("hPtRS_SXiPID",9,binning1);
	TH1F *hPtWS_SXiPID = MakeTH1("hPtWS_SXiPID",9,binning1);
    TH1F *hPtRS_LXiPID = MakeTH1("hPtRS_LXiPID",9,binning1);
	TH1F *hPtWS_LXiPID = MakeTH1("hPtWS_LXiPID",9,binning1);
    TH1F *hPtRS_VTXiPID = MakeTH1("hPtRS_VTXiPID",9,binning1);
	TH1F *hPtWS_VTXiPID = MakeTH1("hPtWS_VTXiPID",9,binning1);
    TH1F *hPtRS_VLXiPID = MakeTH1("hPtRS_VLXiPID",9,binning1);
	TH1F *hPtWS_VLXiPID = MakeTH1("hPtWS_VLXiPID",9,binning1);

    TH1F *hPtRS_TXiPIDRec = MakeTH1("hPtRS_TXiPIDRec",9,binning1);
	TH1F *hPtWS_TXiPIDRec = MakeTH1("hPtWS_TXiPIDRec",9,binning1);
    TH1F *hPtRS_SXiPIDRec = MakeTH1("hPtRS_SXiPIDRec",9,binning1);
	TH1F *hPtWS_SXiPIDRec = MakeTH1("hPtWS_SXiPIDRec",9,binning1);
    TH1F *hPtRS_LXiPIDRec = MakeTH1("hPtRS_LXiPIDRec",9,binning1);
	TH1F *hPtWS_LXiPIDRec = MakeTH1("hPtWS_LXiPIDRec",9,binning1);
    TH1F *hPtRS_VTXiPIDRec = MakeTH1("hPtRS_VTXiPIDRec",9,binning1);
	TH1F *hPtWS_VTXiPIDRec = MakeTH1("hPtWS_VTXiPIDRec",9,binning1);
    TH1F *hPtRS_VLXiPIDRec = MakeTH1("hPtRS_VLXiPIDRec",9,binning1);
	TH1F *hPtWS_VLXiPIDRec = MakeTH1("hPtWS_VLXiPIDRec",9,binning1);

    TH1F *hPtRS_TXiPIDLRec = MakeTH1("hPtRS_TXiPIDLRec",9,binning1);
	TH1F *hPtWS_TXiPIDLRec = MakeTH1("hPtWS_TXiPIDLRec",9,binning1);
    TH1F *hPtRS_SXiPIDSRec = MakeTH1("hPtRS_SXiPIDSRec",9,binning1);
	TH1F *hPtWS_SXiPIDSRec = MakeTH1("hPtWS_SXiPIDSRec",9,binning1);
    TH1F *hPtRS_LXiPIDTRec = MakeTH1("hPtRS_LXiPIDTRec",9,binning1);
	TH1F *hPtWS_LXiPIDTRec = MakeTH1("hPtWS_LXiPIDTRec",9,binning1);
    TH1F *hPtRS_VTXiPIDVLRec = MakeTH1("hPtRS_VTXiPIDVLRec",9,binning1);
	TH1F *hPtWS_VTXiPIDVLRec = MakeTH1("hPtWS_VTXiPIDVLRec",9,binning1);
    TH1F *hPtRS_VLXiPIDVTRec = MakeTH1("hPtRS_VLXiPIDVTRec",9,binning1);
	TH1F *hPtWS_VLXiPIDVTRec = MakeTH1("hPtWS_VLXiPIDVTRec",9,binning1);

    TH1F *hPtRS_SXiPID_V0 = MakeTH1("hPtRS_SXiPID_V0",9,binning1);
	TH1F *hPtWS_SXiPID_V0 = MakeTH1("hPtWS_SXiPID_V0",9,binning1);
    TH1F *hPtRS_SXiPID_Xi = MakeTH1("hPtRS_SXiPID_Xi",9,binning1);
	TH1F *hPtWS_SXiPID_Xi = MakeTH1("hPtWS_SXiPID_Xi",9,binning1);
    TH1F *hPtRS_SXiPID_DCAb = MakeTH1("hPtRS_SXiPID_DCAb",9,binning1);
	TH1F *hPtWS_SXiPID_DCAb = MakeTH1("hPtWS_SXiPID_DCAb",9,binning1);

    TH1F *hPtRS_LeRec = MakeTH1("hPtRS_LeRec",9,binning1);
	TH1F *hPtWS_LeRec = MakeTH1("hPtWS_LeRec",9,binning1);
    TH1F *hPtRS_SeRec = MakeTH1("hPtRS_SeRec",9,binning1);
	TH1F *hPtWS_SeRec = MakeTH1("hPtWS_SeRec",9,binning1);
    TH1F *hPtRS_TeRec = MakeTH1("hPtRS_TeRec",9,binning1);
	TH1F *hPtWS_TeRec = MakeTH1("hPtWS_TeRec",9,binning1);
    TH1F *hPtRS_VTeRec = MakeTH1("hPtRS_VTeRec",9,binning1);
	TH1F *hPtWS_VTeRec = MakeTH1("hPtWS_VTeRec",9,binning1);
    TH1F *hPtRS_VLeRec = MakeTH1("hPtRS_VLeRec",9,binning1);
	TH1F *hPtWS_VLeRec = MakeTH1("hPtWS_VLeRec",9,binning1);

    TH1F *hPtRS_LXiRec = MakeTH1("hPtRS_LXiRec",9,binning1);
	TH1F *hPtWS_LXiRec = MakeTH1("hPtWS_LXiRec",9,binning1);
    TH1F *hPtRS_SXiRec = MakeTH1("hPtRS_SXiRec",9,binning1);
	TH1F *hPtWS_SXiRec = MakeTH1("hPtWS_SXiRec",9,binning1);
    TH1F *hPtRS_TXiRec = MakeTH1("hPtRS_TXiRec",9,binning1);
	TH1F *hPtWS_TXiRec = MakeTH1("hPtWS_TXiRec",9,binning1);
    TH1F *hPtRS_VTXiRec = MakeTH1("hPtRS_VTXiRec",9,binning1);
	TH1F *hPtWS_VTXiRec = MakeTH1("hPtWS_VTXiRec",9,binning1);
    TH1F *hPtRS_VLXiRec = MakeTH1("hPtRS_VLXiRec",9,binning1);
	TH1F *hPtWS_VLXiRec = MakeTH1("hPtWS_VLXiRec",9,binning1);

    TH1F *hPtRS_LeIM = MakeTH1("hPtRS_LeIM",9,binning1);
	TH1F *hPtWS_LeIM = MakeTH1("hPtWS_LeIM",9,binning1);
    TH1F *hPtRS_SeIM = MakeTH1("hPtRS_SeIM",9,binning1);
	TH1F *hPtWS_SeIM = MakeTH1("hPtWS_SeIM",9,binning1);
    TH1F *hPtRS_TeIM = MakeTH1("hPtRS_TeIM",9,binning1);
	TH1F *hPtWS_TeIM = MakeTH1("hPtWS_TeIM",9,binning1);

    TH1F *hPtRS_LOA = MakeTH1("hPtRS_LOA",9,binning1);
	TH1F *hPtWS_LOA = MakeTH1("hPtWS_LOA",9,binning1);
    TH1F *hPtRS_TOA = MakeTH1("hPtRS_TOA",9,binning1);
	TH1F *hPtWS_TOA = MakeTH1("hPtWS_TOA",9,binning1);
    TH1F *hPtRS_SOA = MakeTH1("hPtRS_SOA",9,binning1);
	TH1F *hPtWS_SOA = MakeTH1("hPtWS_SOA",9,binning1);
    ...
    TH1F *hpre_eRec_loose_de = MakeTH1("hpre_eRec_loose_de",9,binning1);
	TH1F *hpre_eRec_loose_nu = MakeTH1("hpre_eRec_loose_nu",9,binning1);
    TH1F *hpre_eRec_stand_de = MakeTH1("hpre_eRec_stand_de",9,binning1);
	TH1F *hpre_eRec_stand_nu = MakeTH1("hpre_eRec_stand_nu",9,binning1);
    TH1F *hpre_eRec_tight_de = MakeTH1("hpre_eRec_tight_de",9,binning1);
	TH1F *hpre_eRec_tight_nu = MakeTH1("hpre_eRec_tight_nu",9,binning1);
    TH1F *hpre_eRec_vloose_de = MakeTH1("hpre_eRec_vloose_de",9,binning1);
	TH1F *hpre_eRec_vloose_nu = MakeTH1("hpre_eRec_vloose_nu",9,binning1);
    TH1F *hpre_eRec_vtight_de = MakeTH1("hpre_eRec_vtight_de",9,binning1);
	TH1F *hpre_eRec_vtight_nu = MakeTH1("hpre_eRec_vtight_nu",9,binning1);

    TH1F *hpre_XiRec_loose_de = MakeTH1("hpre_XiRec_loose_de",9,binning1);
	TH1F *hpre_XiRec_loose_nu = MakeTH1("hpre_XiRec_loose_nu",9,binning1);
    TH1F *hpre_XiRec_stand_de = MakeTH1("hpre_XiRec_stand_de",9,binning1);
	TH1F *hpre_XiRec_stand_nu = MakeTH1("hpre_XiRec_stand_nu",9,binning1);
    TH1F *hpre_XiRec_tight_de = MakeTH1("hpre_XiRec_tight_de",9,binning1);
	TH1F *hpre_XiRec_tight_nu = MakeTH1("hpre_XiRec_tight_nu",9,binning1);
    TH1F *hpre_XiRec_vloose_de = MakeTH1("hpre_XiRec_vloose_de",9,binning1);
	TH1F *hpre_XiRec_vloose_nu = MakeTH1("hpre_XiRec_vloose_nu",9,binning1);
    TH1F *hpre_XiRec_vtight_de = MakeTH1("hpre_XiRec_vtight_de",9,binning1);
	TH1F *hpre_XiRec_vtight_nu = MakeTH1("hpre_XiRec_vtight_nu",9,binning1);

    TH1F *hpre_ePID_loose_de = MakeTH1("hpre_ePID_loose_de",9,binning1);
	TH1F *hpre_ePID_loose_nu = MakeTH1("hpre_ePID_loose_nu",9,binning1);
    TH1F *hpre_ePID_stand_de = MakeTH1("hpre_ePID_stand_de",9,binning1);
	TH1F *hpre_ePID_stand_nu = MakeTH1("hpre_ePID_stand_nu",9,binning1);
    TH1F *hpre_ePID_tight_de = MakeTH1("hpre_ePID_tight_de",9,binning1);
	TH1F *hpre_ePID_tight_nu = MakeTH1("hpre_ePID_tight_nu",9,binning1);
    TH1F *hpre_ePID_vloose_de = MakeTH1("hpre_ePID_vloose_de",9,binning1);
	TH1F *hpre_ePID_vloose_nu = MakeTH1("hpre_ePID_vloose_nu",9,binning1);
    TH1F *hpre_ePID_vtight_de = MakeTH1("hpre_ePID_vtight_de",9,binning1);
	TH1F *hpre_ePID_vtight_nu = MakeTH1("hpre_ePID_vtight_nu",9,binning1);

    TH1F *hpre_XiPID_loose_de = MakeTH1("hpre_XiPID_loose_de",9,binning1);
	TH1F *hpre_XiPID_loose_nu = MakeTH1("hpre_XiPID_loose_nu",9,binning1);
    TH1F *hpre_XiPID_stand_de = MakeTH1("hpre_XiPID_stand_de",9,binning1);
	TH1F *hpre_XiPID_stand_nu = MakeTH1("hpre_XiPID_stand_nu",9,binning1);
    TH1F *hpre_XiPID_tight_de = MakeTH1("hpre_XiPID_tight_de",9,binning1);
	TH1F *hpre_XiPID_tight_nu = MakeTH1("hpre_XiPID_tight_nu",9,binning1);
    TH1F *hpre_XiPID_vloose_de = MakeTH1("hpre_XiPID_vloose_de",9,binning1);
	TH1F *hpre_XiPID_vloose_nu = MakeTH1("hpre_XiPID_vloose_nu",9,binning1);
    TH1F *hpre_XiPID_vtight_de = MakeTH1("hpre_XiPID_vtight_de",9,binning1);
	TH1F *hpre_XiPID_vtight_nu = MakeTH1("hpre_XiPID_vtight_nu",9,binning1);

    TH1F *hpre_XiPIDRec_loose_de = MakeTH1("hpre_XiPIDRec_loose_de",9,binning1);
	TH1F *hpre_XiPIDRec_loose_nu = MakeTH1("hpre_XiPIDRec_loose_nu",9,binning1);
    TH1F *hpre_XiPIDRec_stand_de = MakeTH1("hpre_XiPIDRec_stand_de",9,binning1);
	TH1F *hpre_XiPIDRec_stand_nu = MakeTH1("hpre_XiPIDRec_stand_nu",9,binning1);
    TH1F *hpre_XiPIDRec_tight_de = MakeTH1("hpre_XiPIDRec_tight_de",9,binning1);
	TH1F *hpre_XiPIDRec_tight_nu = MakeTH1("hpre_XiPIDRec_tight_nu",9,binning1);
    TH1F *hpre_XiPIDRec_vloose_de = MakeTH1("hpre_XiPIDRec_vloose_de",9,binning1);
	TH1F *hpre_XiPIDRec_vloose_nu = MakeTH1("hpre_XiPIDRec_vloose_nu",9,binning1);
    TH1F *hpre_XiPIDRec_vtight_de = MakeTH1("hpre_XiPIDRec_vtight_de",9,binning1);
	TH1F *hpre_XiPIDRec_vtight_nu = MakeTH1("hpre_XiPIDRec_vtight_nu",9,binning1);

    TH1F *hpre_XiPIDinvRec_loose_de = MakeTH1("hpre_XiPIDinvRec_loose_de",9,binning1);
	TH1F *hpre_XiPIDinvRec_loose_nu = MakeTH1("hpre_XiPIDinvRec_loose_nu",9,binning1);
    TH1F *hpre_XiPIDinvRec_stand_de = MakeTH1("hpre_XiPIDinvRec_stand_de",9,binning1);
	TH1F *hpre_XiPIDinvRec_stand_nu = MakeTH1("hpre_XiPIDinvRec_stand_nu",9,binning1);
    TH1F *hpre_XiPIDinvRec_tight_de = MakeTH1("hpre_XiPIDinvRec_tight_de",9,binning1);
	TH1F *hpre_XiPIDinvRec_tight_nu = MakeTH1("hpre_XiPIDinvRec_tight_nu",9,binning1);
    TH1F *hpre_XiPIDinvRec_vloose_de = MakeTH1("hpre_XiPIDinvRec_vloose_de",9,binning1);
	TH1F *hpre_XiPIDinvRec_vloose_nu = MakeTH1("hpre_XiPIDinvRec_vloose_nu",9,binning1);
    TH1F *hpre_XiPIDinvRec_vtight_de = MakeTH1("hpre_XiPIDinvRec_vtight_de",9,binning1);
	TH1F *hpre_XiPIDinvRec_vtight_nu = MakeTH1("hpre_XiPIDinvRec_vtight_nu",9,binning1);

    TH1F *hpre_OA_loose_de = MakeTH1("hpre_OA_loose_de",9,binning1);
	TH1F *hpre_OA_loose_nu = MakeTH1("hpre_OA_loose_nu",9,binning1);
    TH1F *hpre_OA_stand_de = MakeTH1("hpre_OA_stand_de",9,binning1);
	TH1F *hpre_OA_stand_nu = MakeTH1("hpre_OA_stand_nu",9,binning1);
    TH1F *hpre_OA_tight_de = MakeTH1("hpre_OA_tight_de",9,binning1);
	TH1F *hpre_OA_tight_nu = MakeTH1("hpre_OA_tight_nu",9,binning1);

    TH1F *hpre_IM_loose_de = MakeTH1("hpre_IM_loose_de",9,binning1);
	TH1F *hpre_IM_loose_nu = MakeTH1("hpre_IM_loose_nu",9,binning1);
    TH1F *hpre_IM_stand_de = MakeTH1("hpre_IM_stand_de",9,binning1);
	TH1F *hpre_IM_stand_nu = MakeTH1("hpre_IM_stand_nu",9,binning1);
    TH1F *hpre_IM_tight_de = MakeTH1("hpre_IM_tight_de",9,binning1);
	TH1F *hpre_IM_tight_nu = MakeTH1("hpre_IM_tight_nu",9,binning1);

    TH1F *hpre_Bayes_stand2_de = MakeTH1("hpre_Bayes_stand2_de",9,binning1);
	TH1F *hpre_Bayes_stand2_nu = MakeTH1("hpre_Bayes_stand2_nu",9,binning1);
    TH1F *hpre_Bayes_stand3_de = MakeTH1("hpre_Bayes_stand3_de",9,binning1);
	TH1F *hpre_Bayes_stand3_nu = MakeTH1("hpre_Bayes_stand3_nu",9,binning1);
    TH1F *hpre_Bayes_stand4_de = MakeTH1("hpre_Bayes_stand4_de",9,binning1);
	TH1F *hpre_Bayes_stand4_nu = MakeTH1("hpre_Bayes_stand4_nu",9,binning1);
    TH1F *hpre_Bayes_stand5_de = MakeTH1("hpre_Bayes_stand5_de",9,binning1);
	TH1F *hpre_Bayes_stand5_nu = MakeTH1("hpre_Bayes_stand5_nu",9,binning1);
    TH1F *hpre_Bayes_stand6_de = MakeTH1("hpre_Bayes_stand6_de",9,binning1);
	TH1F *hpre_Bayes_stand6_nu = MakeTH1("hpre_Bayes_stand6_nu",9,binning1);
    TH1F *hpre_Bayes_stand7_de = MakeTH1("hpre_Bayes_stand7_de",9,binning1);
	TH1F *hpre_Bayes_stand7_nu = MakeTH1("hpre_Bayes_stand7_nu",9,binning1);

    TH1F *hpre_Svd_stand3_de = MakeTH1("hpre_Svd_stand3_de",9,binning1);
	TH1F *hpre_Svd_stand3_nu = MakeTH1("hpre_Svd_stand3_nu",9,binning1);
    TH1F *hpre_Svd_stand4_de = MakeTH1("hpre_Svd_stand4_de",9,binning1);
	TH1F *hpre_Svd_stand4_nu = MakeTH1("hpre_Svd_stand4_nu",9,binning1);
    TH1F *hpre_Svd_stand5_de = MakeTH1("hpre_Svd_stand5_de",9,binning1);
	TH1F *hpre_Svd_stand5_nu = MakeTH1("hpre_Svd_stand5_nu",9,binning1);
    ...
    TH1F *hprompt    = MakeTH1("hprompt",    7, binning1);
	TH1F *hnonprompt = MakeTH1("hnonprompt" ,7, binning1);
	TH1F *hinclu     = MakeTH1("hinclu",     7, binning1);
	...
	for (Int_t i=0; i<nTracks; i++)
	{
		...
		{
			if ( e_crossedratio>65 && TPCPIDCluster>40 && e_crossedratio/e_findable>0.75 &&
				 ITSCluster>=3) e_Recon_VLoose_flag = kTRUE;
			if ( e_crossedratio>65 && TPCPIDCluster>45 && e_crossedratio/e_findable>0.8 &&
		...
		if (IsMC)
		{
			...
			//Fill a
			if (echarge*vcharge>0 && Xi_Recon_Stand_flag && e_PID_Stand_flag &&	Xi_Topology_Stand_flag &&
				PairMass_Stand_flag && OPAngle_Stand_flag && e_Recon_Stand_flag)
			{
				if (fabs(mcXib) == nullV) continue;
				htest3->Fill(mcXib,XibeXi);
				htest1->Fill(XibeXi);
				htest2->Fill(mcXib);
			}
			if (fabs(mcXib)!=nullV && echarge*vcharge>0 && Xi_Recon_Stand_flag && e_PID_Stand_flag &&
				Xi_Topology_Stand_flag && OPAngle_Stand_flag && e_Recon_Stand_flag) htest4->Fill(In_Mass);
			if (fabs(mcXib)!=nullV && echarge*vcharge>0 && Xi_Recon_Stand_flag && e_PID_Stand_flag &&
				Xi_Topology_Stand_flag && PairMass_Stand_flag && e_Recon_Stand_flag) htest5->Fill(cosoa);
			//if(fabs(mcptXic0) == nullV.) continue;
